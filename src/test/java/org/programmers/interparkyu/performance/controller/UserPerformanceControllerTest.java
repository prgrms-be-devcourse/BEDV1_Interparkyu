...
class UserPerformanceControllerTest {
    ...
    void getDetailPerformanceInfo() throws Exception {
        ...
        mockMvc.perform(get("/v1/performances/" + performance.getId())
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].category")
                .value(performance.getCategory().toString()))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].runtime")
                .value(performance.getRuntime()))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].roundInfo[0].round")
                .value(rounds.get(0).round()))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].roundInfo[0].date")
                .value(rounds.get(0).date()))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].roundInfo[0].startTime")
                .value(rounds.get(0).startTime()))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].roundInfo[0].endTime")
                .value(rounds.get(0).endTime()))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].roundInfo[0].ticketingStartDateTime")
                .value(rounds.get(0).ticketingStartDateTime()))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].roundInfo[0].ticketingEndDateTime")
                .value(rounds.get(0).ticketingEndDateTime()))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].roundInfo[0].ticketingCancelableUntil")
                .value(rounds.get(0).ticketingCancelableUntil()))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].roundInfo[0].remainingSeats")
                .value(rounds.get(0).remainingSeats()))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].roundInfo[0].hall")
